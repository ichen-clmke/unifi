...
# Modified for use in the Cyberlynk Networks hosting environment by CyberLynk Networks
#
# Comments regarding CyberLynk modifications are indicated with "CYB:"
...
# CYB: Not applicable for our use case
#
...
# CYB: Doesn't look applicable, will try it without and report back
...
#
# Set the time zone
# CYB: Set permanently to America/Chicago
#
